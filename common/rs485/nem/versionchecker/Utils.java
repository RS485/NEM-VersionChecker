...
public class Utils {
	...
	public static String patchVersion(String modVersion) {
		modVersion = modVersion.replaceAll(Pattern.quote("(" + NEMVersionChecker.getInstance().getMCVersion() + ")"), "");
		modVersion = modVersion.replaceAll(Pattern.quote("[" + NEMVersionChecker.getInstance().getMCVersion() + "]"), "");
		modVersion = modVersion.replaceAll("[\\)\\]]", "").replaceAll("[\\(\\[]", ".");
		modVersion = modVersion.replaceAll(Pattern.quote("_" + NEMVersionChecker.getInstance().getMCVersion()), "");
		modVersion = modVersion.replaceAll(Pattern.quote(NEMVersionChecker.getInstance().getMCVersion() + "_"), "");
